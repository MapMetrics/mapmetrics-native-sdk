...
class LocationComponentTest {
    ...
    private lateinit var developerAnimationListeners: List<MapMetricsMap.OnDeveloperAnimationListener>
    ...
    fun tiltWhileTracking_notReady() {
        ...
        val callback = mock(MapMetricsMap.CancelableCallback::class.java)
