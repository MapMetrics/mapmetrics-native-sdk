...
class MapMetricsMapOptionsAttrsTest {

    @RelaxedMockK
    private lateinit var options: MapMetricsMapOptions
    ...
    fun enabledLocalIdeographFontFamily() {
        ...
        val options = MapMetricsMapOptions.createFromAttributes(options, context, typedArray)
