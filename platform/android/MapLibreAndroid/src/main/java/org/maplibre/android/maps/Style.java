...
public class Style {
      ...
      public static class Builder {
            ...
            @Deprecated
            @NonNull
            public Builder fromUrl(@NonNull String fileName, String token) {
                  this.styleUri = BuildConfig.BASE_URL + fileName + "&token=" + token;
                  return this;
            }
             ...
             */
            @NonNull
            public Builder fromUri(@NonNull String fileName, String token) {
                  this.styleUri = BuildConfig.BASE_URL + fileName + "&token=" + token;
                  return this;
            }
