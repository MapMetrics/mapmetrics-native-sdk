...
interface NativeMap {
  ...
  void setOnFpsChangedListener(@NonNull MapMetricsMap.OnFpsChangedListener listener);
  ...
  void addSnapshotCallback(@NonNull MapMetricsMap.SnapshotReadyCallback callback);
}
