...
class BootstrapTest : AppCenter() {
    ...
    @UiThreadTest
    fun before() {
        apiKeyBackup = MapMetrics.getApiKey()
    }
    ...
    fun after() {
        ...
        MapMetrics.getInstance(context)
    }
    ...
    fun maptilerBootstrap() {
        ...
        val key = "abcdef"
        MapMetrics.getInstance(context, key, WellKnownTileServer.MapTiler)
    ...
    fun duplicateBootstrap() {
        ...
        MapMetrics.getInstance(context, key, WellKnownTileServer.MapTiler)
        MapMetrics.getInstance(context)
        MapMetrics.getInstance(context, key, WellKnownTileServer.Mapbox)
